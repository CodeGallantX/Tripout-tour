                        ...
                        <div>
                            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 w-full">
                                {trends.map((destination, index) => (
                                    <div key={index}>
                                        <div className="group flex flex-row items-center justify-center gap-3 p-4 border border-gray-400 hover:bg-white rounded-xl hover:border-none hover:shadow-lg cursor-pointer transition-all duration-200">
                            ...
                            <Link to="/destinations" className="flex items-center justify-center mt-4">
                                <button className="text-sm text-center font-semibold text-[#F7921E] bg-[#FDE9D1] hover:bg-orange-200 rounded-full md:px-6 px-5 md:py-4 py-3 font-serif">
                                    SEE MORE
