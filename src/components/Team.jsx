                            ...
                            <div className="grid grid-cols-1 gap-8">
                                ...
                                {members.map((member, index) => (
                                    <div key={index} className="relative group">
                                        <div className="w-full max-w-xl mx-4 relative flex flex-col items-center cursor-pointer justify-center py-6 px-8 rounded-xl border border-gray-400 hover:shadow-lg transition-all duration-300 ease-in-out">
